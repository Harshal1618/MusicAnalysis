...
top_freq , top_freq_amp, top_freq_phase = findFrequencies(data, i_framerate = 44100 , i_top_n = 100)
...
wavfile.write('createsound_A4_20180621_v3.wav',i_framerate,soundData)
